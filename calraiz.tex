...
\begin{figure}{h}
	...
	\begin{subfigure}{0.4\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\bicaption{Diagrama de flujo del método del punto fijo. Nótese que la raíz obtenida corresponde a la función $f(x)=g(x)-x$}{Flowchart of fixed point iteration. Root corresponds to $f(x)=g(x)-x$}
	\label{fig:fixedp}
\end{figure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=0.8\textwidth]{pfijo3.pdf}}
		\caption{intervalo inicial}
		\label{fig:pfijo21}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=0.8\textwidth]{pfijo4.pdf}}
		\caption{iteración 1}
	\end{subfigure}	
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=0.8\textwidth]{pfijo5.pdf}}
		\caption{iteracion 2}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=0.8\textwidth]{pfijo6.pdf}}
		\caption{iteracion 3}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=0.8\textwidth]{pfijo7.pdf}}
		\caption{iteracion 4}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=0.8\textwidth]{pfijo8.pdf}}
		\caption{iteracion 5: Raíz de la función}
		\label{fig:pfijo25}
	\end{subfigure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=10cm]{p1fijo0.pdf}
...
\begin{figure}
	\centering
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=\textwidth]{p2fijo1.pdf}}
		\caption{Evolución del algoritmo durante 211 iteraciones}
		\label{fig:pfijo41}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=\textwidth]{p2fijo1d2.eps}}
		\caption{Vista detallada de las ultimas iteraciones de \ref{fig:pfijo41}}
		\label{fig:pfijo42}
	\end{subfigure}	
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=\textwidth]{p2fijo1e.pdf}}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=\textwidth]{p3fijo0.pdf}}
		\caption{intervalo inicial}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=\textwidth]{p3fijo1.pdf}}
		\caption{iteración 1}
	\end{subfigure}	
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=\textwidth]{p3fijo2.pdf}}
		\caption{iteracion 2}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=\textwidth]{p3fijo3.pdf}}
		\caption{iteracion 3}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=\textwidth]{p3fijo3.pdf}}
	...
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		{\includegraphics[width=\textwidth]{p3fijo5.pdf}}
		\caption{iteracion 5: Raíz de la función}
	\end{subfigure}
...
\begin{figure}[h]
	...
	\begin{subfigure}{0.45\textwidth}
		\begin{tikzpicture}[scale=0.7, transform shape]
			...
			(5,-2) node(b)[rectangle,draw=blue, thick,rounded corners]{Compute $c=\frac{a+b}{2}, f(c)$}
			(5,-4) node(c)[diamond,aspect=3,draw=red,thick]{es $\vert a-b \vert < \text{eps(a)}$?}
			(9,-4) node(d)[rectangle,draw=blue,align=center,very thick, rounded corners]{it converges:\\ Then end}
			(5,-6) node(e)[diamond,aspect=3,draw=red,thick]{es $f(a)\cdot f(c) < 0$?}
			(9.5,-6) node(f)[rectangle,draw=blue,thick,rounded corners,align=center]{$b=c$\\$f(b)=f(c)$}
			(5,-8) node(g)[rectangle,draw=blue,thick,rounded corners,align=center]{$a=c$\\$f(a)=f(c)$};
			\draw[blue,-latex](a.south)--(b);
		...
		\end{tikzpicture}
	\end{subfigure}
	\bicaption{Diagrama de flujo del método de la bisección con precisión máxima}{Flow chart of bisection method with maximal precission}
...
\begin{figure}[h]
    \centering
    \subfloat[Órbita elíptica y circunferencia auxiliar]{
    \includegraphics[width=0.5\textwidth]{EcuacionKepler.png}
    \label{fig:my_label}}
    \subfloat[Anomalía excéntrica]{
    \includegraphics[width=0.5\textwidth]{Kepler2.png}
    \label{fig:kepler2}
    }
...
A cualquier punto de la órbita elíptica del planeta le corresponden dos puntos sobre la circunferencia auxiliar:
\begin{enumerate}
...
Queremos calcular la posición de Marte respecto al Sol 80 días terrestres después de que el planeta Marte pase por el perihelio, $P$, (punto más cercano al Sol, que es el foco $F$). Dibujar su órbita y la posición orbital en ese momento.
