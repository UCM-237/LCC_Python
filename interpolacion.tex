\chapter{Interpolación y ajuste de funciones\\ Interpolation and function fitting}\label{interpolacion}
...
\begin{figure}
	\centering
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=7cm]{lse1.png}
		\bicaption{Recta de mínimos cuadrados y residuos obtenidos}{Least squares line and residuals.}\label{fig:residuos1}
	\end{subfigure} 
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=7cm]{lse2.png}
		\bicaption{Parabola de mínimos cuadrados y residuos obtenidos}{Least squares parabola and residuals.}\label{fig:residuos2}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=7cm]{lse3.png}
		\bicaption{polinomio de tercer grado  de mínimos cuadrados y residuos obtenidos}{3-degree polynomial and residuals}  \label{fig:residuos3} 
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=7cm]{lse4.png}
		\bicaption{polinomio de cuarto grado  de mínimos cuadrados y residuos obtenidos}{4-degree polynomial and residuals} \label{fig:residuos4}
	\end{subfigure}
...
\centering
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=6.8cm]{bezier3p.eps}
	\bicaption{Curva original (3 puntos)}{Original curve (3 points)} \label{fig:bz1}
\end{subfigure}
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=6.8cm]{bezier6p.eps}
	\bicaption{Curvas equivalentes de 4 a 6 puntos}{4 to 6 points equivalent curves}\label{fig:bz2}
\end{subfigure}
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=6.8cm]{bezier12p.eps}
	\bicaption{Curvas equivalentes de 4 a 12 puntos}{4 to 12 points Equivalent curves}\label{fig:bz3} 
\end{subfigure}
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=6.8cm]{bezier30p.eps}
	\bicaption{Curvas equivalentes de de 4 a 30 puntos}{4 to 30 points equivalent curve} \label{fig:bz4}
\end{subfigure}
...
\centering
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=7cm]{bezierder.eps}
	\bicaption{Curva de Bézier (4 puntos)}{Bézier's curve (4 points)} \label{fig:bzc} 
\end{subfigure}
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=7cm]{bezierhodg.eps}
	\bicaption{Derivada (hodógrafa)}{Derivative (hodograph)} \label{fig:bzd}
\end{subfigure}
...
\centering
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=7cm]{bezierint.eps}
	\bicaption{Interpolación mediante curvas de Bézier de 3 puntos}{Interpolation using three control points Bezier's curves)} \label{fig:ibz} 
\end{subfigure}
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=7cm]{bezierint2.eps}
	\bicaption{Interpolación mediante curvas de Bézier de 3 y 4 puntos}{Interpolation using 3 and 4 control points Beziers's curves} \label{fig:ibz2}
\end{subfigure}
