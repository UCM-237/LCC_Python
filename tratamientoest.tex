...
\begin{paracol}{2}
	...
	En la línea 29 empleamos el comando \mintinline{python}|plot|, asociado al nuevo \emph{Dataframe}. Por defecto, no representará los valores de cada columna con respecto a la columna de índices que ahora contiene los tiempos en los que se han realizado las correspondientes medidas. El parámetro \mintinline{python}|rot|, inclina las etiquetas del eje x de modo que no se solapen y sean legibles. Es imposible cubrir aquí todas las posibilidades de modificación que admiten los gráficos de Pandas que, a su vez, dependen del módulo matplotlib. Para más información se aconseja consultar la documentación de Pandas. La figura \ref{fig:datosele}
